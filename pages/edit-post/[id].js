...
export default function Post() {
  ...
  async function fetchPost() {
    /* first fetch the individual post by ipfs hash from the network */
    if (!id) return
    let provider
    ...
    /* next fetch the IPFS metadata from the network */
    ...
    /* append the post ID to the post data */
    /* this ID is necessary to make updates to the post */
    data.id = postId;
    setPost(data)
  }
